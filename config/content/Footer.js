...
export default {
  hacknitr: {
    img: 'https://res.cloudinary.com/db4zymomi/image/upload/hacknitr/Group_1_njfegg.png',
    alt: 'HackNITR 3.0',
  },
  icons: {
  ...
  cards: [
    {
      ...
      id: 'footer-card-1',
      img: {
        src: 'https://res.cloudinary.com/db4zymomi/image/upload/hacknitr/Mask_Group_oxm7nx.png',
        alt: 'NIT Rourkela',
      },
    },
    {
      ...
      id: 'footer-card-2',
      img: {
        src: 'https://res.cloudinary.com/db4zymomi/image/upload/hacknitr/Mask_Group_thpmsy.png',
  ...
  organisers: [
    {
      ...
      span: true,
      image: {
        src: 'https://res.cloudinary.com/db4zymomi/image/upload/v1638975894/hacknitr/DSC_NIT_Rourkela_Dark_Horizontal-Logo_1_kebw5n.png',
    ...
    },
    {
      ...
      span: false,
      image: {
        src: 'https://res.cloudinary.com/db4zymomi/image/upload/hacknitr/GitHub_CE_2_ctxaoi.png',
    ...
    },
    {
      ...
      span: false,
      image: {
        src: 'https://res.cloudinary.com/db4zymomi/image/upload/hacknitr/Hack_Club_NIT_Rourkela_q1uixj.png',
