  ...
  PRIZES: [
    {
      ...
      prizes: [
        '₹20,000',
        'Digital Ocean Credits worth upto $2000.',
        'Free Expansion Packs by Leading Learners worth 100$.',
        '1 Axure certificate per team for free 1-year subscription licenses of Axure RP Team Edition.',
        'Access to Wolfram|One technology and Wolfram API.',
        'Free .xyz domains for 1 year.',
        'Gift vouchers from HoverRobotix Hoverboards India worth Rs 10000/- each.',
        'Async online mock interviews with unlimited practice from Interview Buddy.',
        'Premium Fueler Accounts.',
        '1-month FREE access to all Business Plan features of the echo3D platform.',
        'Free 6-months access to Team License from Voiceflow.',
      ],
    },
    {
      id: 'overall-prize-2',
