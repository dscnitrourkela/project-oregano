...
from './Container';
export { default as Heading1 }
from './Typography/Heading1';
export { default as Heading2 }
from './Typography/Heading2';
export { default as Heading3 }
