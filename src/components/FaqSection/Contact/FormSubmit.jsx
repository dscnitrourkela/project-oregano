      ...
      <Form>
        <form onSubmit={handleSubmit} noValidate>
          <Username>
            ...
            />
            <ErrorComponent>{errors.username && <Error>{errors.username}</Error>}</ErrorComponent>
          </Username>
          <Email>
            ...
            />
            <ErrorComponent>{errors.email && <Error>{errors.email}</Error>}</ErrorComponent>
          </Email>
          <Message>
            ...
            />
            <ErrorComponent>{errors.text && <Error>{errors.text}</Error>}</ErrorComponent>
          </Message>
          <Component>
